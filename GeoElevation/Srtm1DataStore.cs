...
{
    /// <summary>
    /// The SRTM1 data store.
    /// </summary>
    public sealed class Srtm1DataStore : GeoElevationDataStore
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes static members of the <see cref="Srtm1DataStore"/> class.
        /// </summary>
        static Srtm1DataStore()
        {
            FileStreams = new ConcurrentDictionary<string, FileStream>();
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="Srtm1DataStore"/> class.
        /// </summary>
        /// <param name="dataFileDirectory">
        /// The data file directory.
        /// </param>
        public Srtm1DataStore(string dataFileDirectory)
        ...
        /// The row count.
        /// </summary>
        protected override int RowCount => 3601;

        /// <summary>
        /// The column count.
        /// </summary>
        protected override int ColumnCount => 3601;
        ...
        {
            var filename = $"{GetSouthwestCornerFilename(targetCoordinates)}.{this.DataFileExtension}";
            FileStream stream;
